    ...
    return (
        <div className="flex flex-col w-1/3 rounded border-5 border-black font-mono">
            <div className="flex h-1/9 bg-black">
                <div className="flex justify-center place-items-center w-1/2 cursor-pointer text-fuchsia-500 hover:bg-fuchsia-200 hover:text-black">
                    Tools
                </div>
                <div className="flex justify-center place-items-center w-1/2 cursor-pointer text-fuchsia-500 hover:bg-fuchsia-200 hover:text-black">
                    Gallery
            ...
            <div className="flex flex-col h-8/9">
                {items.map((item, index) => (
                    <div className="flex justify-left place-items-center w-full border-t-2 border-black h-1/4 gap-10 pl-10 cursor-pointer hover:bg-fuchsia-600">
                        <div className="text-fuchsia-300">{item.title}</div>
