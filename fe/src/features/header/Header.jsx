...
const Header = (props) => {
  ...
  return (
    <div className="flex relative mb-2 rounded p-2 h-1/9 gap-10">
      {titleWords.map((word, i) => (
        <div className="relative" style={{width: `${word.length * 28}px`}}>
            ...
            >
              {word.split("").map((character, k) => (
                <div className="flex flex-col">
                  {characterMatrices[character.charCodeAt(0) - 65].map(
                    (row, m) => (
